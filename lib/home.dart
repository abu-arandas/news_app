                                ...
                                children: [
                                  ...
                                  IconButton(
                                    onPressed: () => Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                        builder: (context) => ArticleDetails(article: snapshot.data!.articles![index]),
                                      ),
                                    ),
                                    ...
                                    children: [
                                      ...
                                      TextButton(
                                        onPressed: () => Navigator.push(
                                          context,
                                          MaterialPageRoute(
                                            builder: (context) => ArticleDetails(article: snapshot.data!.articles![i]),
                                          ),
                                        ),
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                gradient: LinearGradient(
                                  ...
                                  colors: [Theme.of(context).primaryColorDark, Theme.of(context).dividerColor, Colors.transparent],
                                ),
                              ),
                            )
                          ],
